...
python3 statistic-utils/graphics_drawing.py -f FEATURES_FILE -o OUTPUT_DIR
...
decades = [1810, 1820, 1830, 1840, 1850, 1860, 1870, 1880, 1890, 1900, 1910, 1920, 1930, 1940, 1950, 1960, 1970, 1980, 1990, 2000, 2010, 2020]
...
if __name__ == "__main__":
    ...
    MAIN_TENDENCIES = DATA[['diacope', 'polysyndeton', 'one_word', 'feat_per_sent']]
    SMALL_TENDENCIES = DATA[['anaphora', 'epiphora', 'symploce']]
    INNER_TENDENCIES = DATA[['anadiplosis', 'epizeuxis', 'epanalepsis']]
    #create_plot_by_decades(MAIN_TENDENCIES, 'rhythm_features_main_' + FEATURES_FILE[:-4], OUTPUT)
    #create_plot_by_decades(SMALL_TENDENCIES, 'rhythm_features_anaphora_etc_' + FEATURES_FILE[:-4], OUTPUT)
    create_plot_by_separate_texts(MAIN_TENDENCIES, 'rhythm_features_main_' + FEATURES_FILE[:-4], OUTPUT)
    create_plot_by_separate_texts(SMALL_TENDENCIES, 'rhythm_features_anaphora_' + FEATURES_FILE[:-4], OUTPUT)
    create_plot_by_separate_texts(INNER_TENDENCIES, 'rhythm_features_anadiplosis_' + FEATURES_FILE[:-4], OUTPUT)
