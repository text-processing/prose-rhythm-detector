...
csv_filenames = [
    "all_char_en.csv", "all_word_en.csv", "all_rhythm_en.csv", "all_char_and_rhythm_en.csv", "all_char_and_word_en.csv", "all_word_and_rhythm_en.csv", "all_features_en.csv", 
    "all_char_ru.csv", "all_word_ru.csv", "all_rhythm_ru.csv", "all_char_and_rhythm_ru.csv", "all_char_and_word_ru.csv", "all_word_and_rhythm_ru.csv", "all_features_ru.csv",
    "all_char_fr.csv", "all_word_fr.csv", "all_rhythm_fr.csv", "all_char_and_rhythm_fr.csv", "all_char_and_word_fr.csv", "all_word_and_rhythm_fr.csv", "all_features_fr.csv"
    ]
result_file = open('century_res.txt', "w")
